...
public class AuthenticationService {
    ...
    public boolean decide(HttpServletRequest authRequest) {
        ...
        //获取此访问用户所有角色拥有的权限资源
        List<Resources> userResources = findResourcesByUsername(authentication.getName());
     ...
     * @return
     */
    public boolean isMatch(ConfigAttribute urlConfigAttribute, List<Resources> userResources) {
     ...
     * @return
     */
    private List<Resources> findResourcesByUsername(String username) {
        //用户被授予的角色资源
        List<Resources> resources = resourceService.queryByUsername(username);
