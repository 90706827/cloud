package com.zgcenv.core.jackson;
...
import static com.zgcenv.core.utils.DateUtils.DEFAULT_DATE_TIME_FORMAT;
...
public class JsonUtil {
    ...
    public static byte[] toJsonAsBytes(Object object) {
        try {
            ...
            throw new BizException(RespCode.JSON_PARSE_ERROR, e);
        }
    }
    ...
    public static <T> List<T> parseArray(String content, Class<T> valueTypeRef) {
        try {
            if (!StrUtil.startWith(content, StrUtil.BRACKET_START)) {
                content = new StringBuilder().append(StrUtil.BRACKET_START)
                        .append(content).append(StrUtil.BRACKET_END).toString();
            }
